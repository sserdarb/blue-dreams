...
const translations: Record<AdminLocale, AdminTranslations> = {
    tr: {
        ...
        guestCountry: 'Misafir Milliyeti',
        ...
        agencyAnalysis: 'Acente & Ülke Bazlı Analiz',
        ...
        bigDataPage: {
            ...
            overview: { budgetRealization: 'Bütçe Gerçekleşme', monthlyRevVsBudget: 'Aylık Gelir vs Bütçe', channelDist: 'Kanal Dağılımı', adrTrendMonthly: 'ADR Trendi (Aylık)', occupancyRate: 'Doluluk Oranı', countryDist: 'Milliyet Dağılımı', boardType: 'Pansiyon Tipi' },
            ...
            channels: { title: '📡 Kanal & Acente Analizi — 7 Rapor & Grafik', r19: 'R19: Kanal Dağılımı', r20: 'R20: Kanal Bazlı Gelir Trendi', r21: 'R21: Kanal Bazlı ADR', r22: 'R22: Kanal Performans Trendi', r23: 'R23: OTA vs Direkt', r25: 'R25: Kanal Mix Değişimi (%)', r24: 'R24: Acente Sıralaması (Top 30)', tableTitle: 'Kanal Özet Tablosu' },
    ...
    en: {
        ...
        bigDataPage: {
            ...
            overview: { budgetRealization: 'Budget Realization', monthlyRevVsBudget: 'Monthly Revenue vs Budget', channelDist: 'Channel Distribution', adrTrendMonthly: 'ADR Trend (Monthly)', occupancyRate: 'Occupancy Rate', countryDist: 'Country Distribution', boardType: 'Board Type' },
    ...
    de: {
        ...
        guestCountry: 'Gästenationalität',
        overview: 'Übersicht',
    ...
    ru: {
        ...
        guestCountry: 'Национальность Гостей',
        overview: 'Обзор',
...
export interface AdminTranslations {
    ...
    bigDataPage: {
        ...
        overview: { budgetRealization: string; monthlyRevVsBudget: string; channelDist: string; adrTrendMonthly: string; occupancyRate: string; countryDist: string; boardType: string }
