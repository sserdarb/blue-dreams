...
export const defaultFactsheetData = {
  ...
  rooms: [
    { title: "Club Room", size: "24m²", description: "Garden or partial sea views, hillside bungalow style." },
    { title: "Club Sea View Room", size: "24m²", description: "Panoramic Aegean views with private balconies." },
    { title: "Club Family Room", size: "35-40m²", description: "Two separate bedrooms, ideal for families." },
    { title: "Deluxe Sea View Room", size: "40m²", description: "Located in the main building, premium furnishings, expansive sea views." }
  ],
  beachAndPools: [
  ...
  dining: [
    { title: "Main Restaurant", description: "International buffet with live cooking stations and theme nights." },
    { title: "À la Carte", description: "Italian, Seafood, Turkish, Steakhouse." }
  ],
  features: {
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-xs text-slate-500 mb-4">
        Factsheet verilerini aşağıdaki JSON formatında düzenleyebilirsiniz. Değişiklikler anında ön yüze yansıyacaktır.
      </p>
