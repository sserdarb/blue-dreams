...
const BookingWidget: React.FC = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Show immediately on mobile if user has scrolled past hero, or just always show after a bit
  ...
  return (
    <div 
      className={`fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-gray-100 shadow-[0_-5px_25px_rgba(0,0,0,0.1)] transition-transform duration-500 ease-in-out ${
