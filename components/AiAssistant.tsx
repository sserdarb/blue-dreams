...
const ContactWidget = () => (
  <div className="grid grid-cols-2 gap-4 mt-2">
    ...
    <a href="https://wa.me/905495167803" target="_blank" rel="noreferrer" className="flex flex-col items-center justify-center p-6 bg-white/80 backdrop-blur rounded-2xl border border-white/20 shadow-sm hover:shadow-md transition-all group">
