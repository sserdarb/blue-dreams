    ...
    <footer id="footer" className="bg-[#111] text-gray-400">
      ...
      <div className="bg-brand py-12 px-6">
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-between text-center md:text-left">
          ...
          <button className="bg-white text-brand px-8 py-3 font-bold uppercase tracking-wider hover:bg-brand-dark hover:text-white transition-colors shadow-lg">
            Bizi Arayın
          </button>
        </div>
      </div>
      ...
      <div className="container mx-auto px-6 py-20">
        {/* Changed grid to 2 columns on tablet (md) and 4 on desktop (lg) */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><a href="#" className="hover:text-brand transition-colors">Odalar & Suitler</a></li>
              <li><a href="#" className="hover:text-brand transition-colors">Fotoğraf Galerisi</a></li>
              <li><a href="#" className="hover:text-brand transition-colors">Spa & Wellness</a></li>
