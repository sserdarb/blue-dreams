...
export default function DeluxeRoomsPage() {
    const room = ROOM_TYPES.find(r => r.id === 'deluxe')!
        ...
        <div>
            <PageHeader
                ...
                breadcrumbs={[
                    ...
                    { label: 'Deluxe Odalar', href: '/tr/odalar/deluxe' },
                ]}
            />
            ...
            <section className="py-16 bg-brand-dark text-white">
                <div className="container mx-auto px-6 text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        {ROOM_TYPES.filter(r => r.id !== 'deluxe').map(r => (
                            <a
                                key={r.id}
