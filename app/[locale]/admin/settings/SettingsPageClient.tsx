...
export default function SettingsPageClient({ locale, initialSettings }: SettingsPageClientProps) {
    const [mainTab, setMainTab] = useState<MainTab>('modules')

    return (
        <div className="space-y-6">
            {/* Top-level tab switcher */}
            <div className="flex gap-1 bg-slate-100 dark:bg-white/5 rounded-xl p-1 border border-slate-200 dark:border-white/10 max-w-lg">
                <button
