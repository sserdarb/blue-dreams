...
export default function YieldManagementClient({ locale, data, error }: Props) {
    ...
    const t = {
        ...
        monthlyAdrRoomNight: locale === 'tr' ? 'Aylık ADR & Oda Geceleme' : 'Monthly ADR & Room Nights',
        ...
        roomNightShare: locale === 'tr' ? 'Oda Geceleme Payı' : 'Room Night Share',
    ...
    const channelData = useMemo(() => {
        ...
        return Array.from(map.entries())
            .map(([name, d]) => ({
                ...
                roomNightLabel: locale === 'tr' ? 'Oda Geceleme' : 'Room Nights',
