        ...
        <div className="space-y-6">
            ...
            {showSettings && (
                <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-5 shadow-sm">
                    ...
                    <div className="mb-6 p-4 border border-slate-200 dark:border-slate-700 rounded-xl bg-slate-50 dark:bg-slate-900 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                        <div>
                            <h4 className="text-sm font-bold text-slate-800 dark:text-white mb-1 flex items-center gap-2">
                                ...
                                Google Güvenli Giriş (OAuth)
                            </h4>
                            <p className="text-xs text-slate-500">Google hesabınızla güvenli giriş yaparak form doldurmadan e-postalarınızı bağlayın.</p>
                        </div>
                        <button onClick={() => window.location.href = '/api/auth/google/tasks'} className="flex-shrink-0 px-4 py-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-sm font-bold text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors shadow-sm flex items-center gap-2">
                            Google İle Bağlan
                        </button>
                    </div>
                    ...
                    <div className="relative mb-6 text-center">
                        ...
                        <span className="relative bg-white dark:bg-slate-800 px-3 text-xs font-semibold text-slate-400 uppercase">veya manuel / iMAP ekleyin</span>
                    </div>
