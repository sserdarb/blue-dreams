    ...
    <div className="space-y-8">
      ...
      {roomBreakdown.length > 0 && (
        <div className="bg-white/5 border border-white/10 rounded-xl p-6">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-xl font-bold text-white">Oda Durumu</h2>
            <span className="ml-2 px-2 py-0.5 bg-emerald-500/20 text-emerald-400 text-xs rounded-full font-medium">Canlı</span>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {roomBreakdown.map((room) => {
              ...
              return (
                <div key={room.name} className="bg-white/5 rounded-lg p-4">
                  <p className="text-slate-400 text-xs font-medium truncate" title={room.name}>{room.name}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-white/5 border border-white/10 rounded-xl p-6">
          <div className="flex items-center gap-2 mb-6">
            <h2 className="text-xl font-bold text-white">Satış Performansı (Son 14 Gün)</h2>
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-6">
          <div className="flex items-center gap-2 mb-6">
            <h2 className="text-xl font-bold text-white">Kanal Dağılımı</h2>
            <span className="px-2 py-0.5 bg-emerald-500/20 text-emerald-400 text-xs rounded-full font-medium">Canlı</span>
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-white/10">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-white/5 rounded-lg p-3 text-center">
                <p className="text-2xl font-bold text-white">{stats.monthlyReservationCount}</p>
                <p className="text-slate-500 text-xs">Rezervasyon</p>
              </div>
              <div className="bg-white/5 rounded-lg p-3 text-center">
                <p className="text-2xl font-bold text-white">{stats.adr}</p>
